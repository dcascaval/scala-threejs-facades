...
class WebGLMultipleRenderTargets extends EventDispatcher:
  ...
  def setSize(width: Double, height: Double, depth: js.UndefOr[Double] = js.undefined): this.type =
    js.native
...
sealed trait Renderer extends js.Object:
  ...
  def setSize(width: Double, height: Double, updateStyle: js.UndefOr[Boolean] = js.undefined): Unit =
    js.native
...
class WebGLRenderer extends Renderer:
  def this(parameters: js.UndefOr[WebGLRendererParameters] = js.undefined) = this()
  ...
  def setClearColor(color: ColorRepresentation, alpha: js.UndefOr[Double] = js.undefined): Unit =
    js.native
  ...
  def setRenderTarget(
      ...
      activeCubeFace: js.UndefOr[Double] = js.undefined,
      activeMipmapLevel: js.UndefOr[Double] = js.undefined
  ): Unit = js.native
  def readRenderTargetPixels(
      ...
      height: Double,
      buffer: js.Any,
      activeCubeFaceIndex: js.UndefOr[Double] = js.undefined
  ): Unit = js.native
  def copyFramebufferToTexture(
      position: Vector2,
      texture: Texture,
...
class WebGLRenderTarget extends EventDispatcher:
  def this(width: Double, height: Double, options: js.UndefOr[WebGLRenderTargetOptions] = js.undefined) =
    this()
