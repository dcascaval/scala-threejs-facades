...
class AnimationAction extends js.Object:
  def this(
      ...
      clip: AnimationClip,
      localRoot: js.UndefOr[Object3D] = js.undefined,
      blendMode: js.UndefOr[AnimationBlendMode] = js.undefined
  ) = this()
...
object PropertyBinding extends js.Object:
  ...
  def create(
      root: js.Any,
      path: js.Any,
      parsedPath: js.UndefOr[js.Any] = js.undefined
...
object AnimationUtils extends js.Object:
  ...
  def makeClipAdditive(
      ...
      referenceFrame: js.UndefOr[Double] = js.undefined,
      referenceClip: js.UndefOr[AnimationClip] = js.undefined,
      fps: js.UndefOr[Double] = js.undefined
  ): AnimationClip = js.native
...
class AnimationClip extends js.Object:
  def this(
      ...
      tracks: js.UndefOr[js.Array[KeyframeTrack]] = js.undefined,
      blendMode: js.UndefOr[AnimationBlendMode] = js.undefined
  ) = this()
  var name: String = js.native
...
class AnimationMixer extends EventDispatcher:
  ...
  def clipAction(
      clip: AnimationClip,
      root: js.UndefOr[Object3D | AnimationObjectGroup] = js.undefined,
      blendMode: js.UndefOr[AnimationBlendMode] = js.undefined
...
@js.native
sealed trait AnonObject6 extends js.Object:
  @JSBracketAccess
  def apply(bindingType: String): Double = js.native

@js.native
sealed trait AnonObject7 extends js.Object:
  @JSBracketAccess
  def apply(versioning: String): Double = js.native

@js.native
sealed trait AnonObject8 extends js.Object:
