...
class SkinnedMesh[TGeometry <: BufferGeometry, TMaterial <: Material | js.Array[Material]]
    extends Mesh[TGeometry, TMaterial]:
  def this(
      geometry: js.UndefOr[TGeometry] = js.undefined,
      material: js.UndefOr[TMaterial] = js.undefined,
      useVertexTexture: js.UndefOr[Boolean] = js.undefined
  ) = this()
...
class LineSegments[TGeometry <: BufferGeometry, TMaterial <: Material | js.Array[Material]]
...
class InstancedMesh[TGeometry <: BufferGeometry, TMaterial <: Material | js.Array[Material]]
    extends Mesh[TGeometry, TMaterial]:
...
class LineLoop[TGeometry <: BufferGeometry, TMaterial <: Material | js.Array[Material]]
    extends Line[TGeometry, TMaterial]:
  def this(
      geometry: js.UndefOr[TGeometry] = js.undefined,
      material: js.UndefOr[TMaterial] = js.undefined
...
@js.native
sealed trait AnonObject2 extends js.Object:
  @JSBracketAccess
  def apply(key: String): Double = js.native

@js.native
sealed trait AnonObject3 extends js.Object:
