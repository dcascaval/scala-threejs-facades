...
class PointLightHelper extends Object3D:
	def this(light: PointLight, sphereSize: js.UndefOr[Double] = js.undefined, color: js.UndefOr[ColorRepresentation] = js.undefined) = this()
...
class HemisphereLightHelper extends Object3D:
	def this(light: HemisphereLight, size: Double, color: js.UndefOr[ColorRepresentation] = js.undefined) = this()
...
class PlaneHelper extends LineSegments[BufferGeometry,Material | js.Array[Material]]:
	def this(plane: Plane, size: js.UndefOr[Double] = js.undefined, hex: js.UndefOr[Double] = js.undefined) = this()
...
class DirectionalLightHelper extends Object3D:
	def this(light: DirectionalLight, size: js.UndefOr[Double] = js.undefined, color: js.UndefOr[ColorRepresentation] = js.undefined) = this()
...
class GridHelper extends LineSegments[BufferGeometry,Material | js.Array[Material]]:
	def this(size: js.UndefOr[Double] = js.undefined, divisions: js.UndefOr[Double] = js.undefined, color1: js.UndefOr[ColorRepresentation] = js.undefined, color2: js.UndefOr[ColorRepresentation] = js.undefined) = this()
...
class PolarGridHelper extends LineSegments[BufferGeometry,Material | js.Array[Material]]:
	def this(radius: js.UndefOr[Double] = js.undefined, radials: js.UndefOr[Double] = js.undefined, circles: js.UndefOr[Double] = js.undefined, divisions: js.UndefOr[Double] = js.undefined, color1: js.UndefOr[ColorRepresentation] = js.undefined, color2: js.UndefOr[ColorRepresentation] = js.undefined) = this()
...
class ArrowHelper extends Object3D:
	def this(dir: js.UndefOr[Vector3] = js.undefined, origin: js.UndefOr[Vector3] = js.undefined, length: js.UndefOr[Double] = js.undefined, color: js.UndefOr[ColorRepresentation] = js.undefined, headLength: js.UndefOr[Double] = js.undefined, headWidth: js.UndefOr[Double] = js.undefined) = this()
